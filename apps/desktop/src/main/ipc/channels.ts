...
export const FUNDET_INVOKE = {
  ...
  SESSION_GET_INTERRUPTED: 'session:get-interrupted',
  SIDEBAR_PINNED_GET: 'sidebar:get-pinned',
  ...
  KB_REMOVE_ITEM: 'kb:remove-item',
  KB_SEARCH: 'kb:search',
  KB_PICK_FILES: 'kb:pick-files',
  KB_RETRY: 'kb:retry',
  ...
  BROWSER_SET_ALLOW_PRIVATE: 'browser:set-allow-private',
