...
// upstream: extensions/browser/src/browser/unhandled-rejections.ts
/**
 * Browser-specific unhandled rejection filter for benign Playwright dialog
 * races.
 */
import { collectErrorGraphCandidates } from "../../../../shim/error-runtime.js";
import { registerUnhandledRejectionHandler } from "../../../../shim/runtime-env.js";
